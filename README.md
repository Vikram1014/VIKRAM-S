...
![Shell](https://img.shields.io/badge/Shell_Script-121011?style=flat-square&logo=gnubash&logoColor=white)

**Bioinformatics & Frameworks**

![R Shiny](https://img.shields.io/badge/R%20Shiny-blue?style=flat-square&logo=r&logoColor=white)
![DESeq2](https://img.shields.io/badge/DESeq2-005C5C?style=flat-square)
![Modeller](https://img.shields.io/badge/Modeller-E37400?style=flat-square)
![KEGG](https://img.shields.io/badge/KEGG%20Pathways-1F6F8B?style=flat-square)
![GO Enrichment](https://img.shields.io/badge/GO%20Enrichment-2E8B57?style=flat-square)
...
![Apache Jena Fuseki](https://img.shields.io/badge/Apache%20Jena%20Fuseki-D22128?style=flat-square&logo=apache&logoColor=white)
![SPARQL](https://img.shields.io/badge/SPARQL-005A9C?style=flat-square)
...
![Vikram's GitHub stats](https://github-readme-stats.vercel.app/api?username=Vikram1014&show_icons=true&theme=tokyonight&hide_border=true)

![Top Langs](https://github-readme-stats.vercel.app/api/top-langs/?username=Vikram1014&layout=compact&theme=tokyonight&hide_border=true)

![GitHub Streak](https://streak-stats.demolab.com?user=Vikram1014&theme=tokyonight&hide_border=true)

![Activity Graph](https://github-readme-activity-graph.vercel.app/graph?username=Vikram1014&theme=tokyo-night&hide_border=true)

![Trophies](https://github-profile-trophy.vercel.app/?username=Vikram1014&theme=tokyonight&no-frame=true&no-bg=true&row=1&column=7)
...
<details>
<summary>🔬 <strong>Research Intern</strong> — National Centre for Biological Sciences (NCBS), Bengaluru | Dec 2025 – Feb 2026</summary>
<br>

- RNA isolation, quality assessment, and sample preparation for RNA sequencing.
- End-to-end bulk RNA-seq data analysis, including expression quantification and differential expression analysis.
- DEG identification using **DESeq2 (R)** and transcriptome-wide expression profiling.
- Visualization and interpretation of RNA-seq results using PCA, heatmaps, and volcano plots.
- Functional annotation and pathway enrichment analysis using **GO** and **KEGG** databases.
...
|:---:|:---:|:---|
| 🦟 **Canna indica vs Dengue Virus** | Molecular Docking, Modeller, ADMET | In-silico evaluation of *Canna indica*-derived phytochemicals as potential inhibitors of dengue virus target proteins |
| 💊 **ADMET Analysis App** | Perl | Mobile application for automated pharmacokinetic property prediction with input validation |
| 📈 **Correlation Analysis Dashboard** | R, R Shiny | Interactive dashboard for correlation analysis and visualization of variable relationships |
| 🧬 **Genome Search Engine** *(ongoing)* | Apache Jena Fuseki, SPARQL, PHP | High-performance engine for rapid querying and retrieval of genomic data |
...
**B.Tech in Biotechnology** — Tamil Nadu Agricultural University
